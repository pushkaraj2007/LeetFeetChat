...
router.post('/signup', upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    let mailOptions = {
      ...
      text: `Link For Validating You Account Is ${'https://leetfeetchat.herokuapp.com/verify-account/' + userAuthId}`
    };
  ...
  try {
    ...
    if(user.verified == false){
      ...
      let mailOptions = {
        ...
        to: req.body.email,
        subject: 'Verification Link For LeetFeetChat',
        text: `Link For Validating You Account Is ${'https://leetfeetchat.herokuapp.com/verify-account/' + user.userAuthId}`
      };
